---
article_id: ABR-16-03
title: "Bunyi, Getaran, Bau, dan Fault Code: Membangun Timeline Kerusakan"
slug: "timeline-gejala-kerusakan-alat-berat"
description: "Show how to record onset, operating state, location, load, direction, temperature, warning, code, sound/video safely, recent work, and recurrence"
status: outline
publication_date: "2026-05-25"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: ABR-16
primary_intent: "Preserve multi-signal diagnostic evidence"
reader_community: "Berat.id"
reader_address: "Kawan Berat.id"
final_route: "/artikel/timeline-gejala-kerusakan-alat-berat.html"
...
# Bunyi, Getaran, Bau, dan Fault Code: Membangun Timeline Kerusakan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Bunyi, Getaran, Bau, dan Fault Code: Membangun Timeline Kerusakan”
- **Reader and situation:** Operator or supervisor reporting intermittent or worsening faults
- **Reader outcome:** Show how to record onset, operating state, location, load, direction, temperature, warning, code, sound/video safely, recent work, and recurrence
- **Primary intent:** Preserve multi-signal diagnostic evidence
...
- **Scope boundary:** Excludes diagnosing by sound alone and unsafe close-up recording; ABR-10-05 owns code handling and technician testing owns root cause
- **Final public route:** `/artikel/timeline-gejala-kerusakan-alat-berat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Bunyi, Getaran, Bau, dan Fault Code: Membangun Timeline Kerusakan**.
...
- `/jual-sewa-alat-berat-bau-bau` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- `ABR-16-01` → `/artikel/alat-berat-overheating-triage.html` — Alat Berat Overheating: Triage Aman dan Bukti yang Harus Dikumpulkan
- `ABR-16-02` → `/artikel/tenaga-turun-gerak-lambat-hydraulic-drift.html` — Tenaga Turun, Gerak Lambat, atau Hydraulic Drift: Memisahkan Gejala
- `ABR-16-04` → `/artikel/defek-kritis-alat-berat-stop-dan-isolasi.html` — Defek Kritis Alat Berat: Kapan Harus Stop, Isolasi, dan Eskalasi
- `ABR-16-05` → `/artikel/root-cause-analysis-kerusakan-berulang-alat-berat.html` — Root Cause Analysis Kerusakan Berulang Alat Berat
...
- **Tie back to this article:** Keep the explanation specific to “Bunyi, Getaran, Bau, dan Fault Code: Membangun Timeline Kerusakan”.
