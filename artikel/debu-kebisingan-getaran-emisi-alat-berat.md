---
article_id: ABR-17-04
title: "Debu, Kebisingan, Getaran, dan Emisi di Sekitar Alat Berat"
slug: "debu-kebisingan-getaran-emisi-alat-berat"
description: "Apply source-pathway-receptor logic to engines, travel, breaking, crushing, loading, haul roads, alarms, and maintenance; define measurement and escalation"
status: outline
publication_date: "2026-06-21"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: ABR-17
primary_intent: "Identify exposure pathways and controls"
reader_community: "Berat.id"
reader_address: "Teman Berat.id"
final_route: "/artikel/debu-kebisingan-getaran-emisi-alat-berat.html"
...
# Debu, Kebisingan, Getaran, dan Emisi di Sekitar Alat Berat

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Debu, Kebisingan, Getaran, dan Emisi di Sekitar Alat Berat”
- **Reader and situation:** Site manager receiving worker or neighbor concerns
- **Reader outcome:** Apply source-pathway-receptor logic to engines, travel, breaking, crushing, loading, haul roads, alarms, and maintenance; define measurement and escalation
- **Primary intent:** Identify exposure pathways and controls
...
- **Scope boundary:** Excludes declaring compliance without monitoring and project limits; ABR-06-06 owns processing-plant controls and competent environmental/OH professionals own assessment
- **Final public route:** `/artikel/debu-kebisingan-getaran-emisi-alat-berat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Debu, Kebisingan, Getaran, dan Emisi di Sekitar Alat Berat**.
...
- `ABR-17-03` → `/artikel/diesel-hybrid-electric-heavy-equipment.html` — Diesel, Hybrid, dan Electric Heavy Equipment: Batas Perbandingan
- `ABR-17-05` → `/artikel/limbah-perawatan-alat-berat.html` — Oli Bekas, Filter, Battery, Ban, dan Komponen: Alur Limbah Alat Berat
- `ABR-17-06` → `/artikel/decommissioning-dan-pemulihan-area-alat-berat.html` — Demobilisasi, Decommissioning, dan Pemulihan Area Kerja Alat Berat
...
- **Tie back to this article:** Keep the explanation specific to “Debu, Kebisingan, Getaran, dan Emisi di Sekitar Alat Berat”.
