---
article_id: ABR-03-01
title: "Excavator, Bulldozer, Loader, Scraper, atau Grader: Fungsi yang Berbeda"
slug: "excavator-bulldozer-loader-scraper-grader"
description: "Match each family to digging, pushing, loading, hauling, spreading, and finish-grading tasks and identify handoffs"
status: outline
publication_date: "2025-07-05"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: ABR-03
primary_intent: "Compare earthmoving machine roles"
reader_community: "Berat.id"
reader_address: "Kawan Berat.id"
final_route: "/artikel/excavator-bulldozer-loader-scraper-grader.html"
...
# Excavator, Bulldozer, Loader, Scraper, atau Grader: Fungsi yang Berbeda

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Excavator, Bulldozer, Loader, Scraper, atau Grader: Fungsi yang Berbeda”
- **Reader and situation:** Buyer choosing among machines that appear interchangeable
- **Reader outcome:** Match each family to digging, pushing, loading, hauling, spreading, and finish-grading tasks and identify handoffs
- **Primary intent:** Compare earthmoving machine roles
...
- **Scope boundary:** Excludes model sizing and rental offers; ABR-02-02 owns productivity and machine category routes own quotations
- **Final public route:** `/artikel/excavator-bulldozer-loader-scraper-grader.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Excavator, Bulldozer, Loader, Scraper, atau Grader: Fungsi yang Berbeda**.
...
- `/wheel-track-loader` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/bulldozer` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/wheel-track-loader/` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/motor/scraper` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/motor/grader` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jual-rental/wheel-loader-track-loader-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Excavator, Bulldozer, Loader, Scraper, atau Grader: Fungsi yang Berbeda”.
