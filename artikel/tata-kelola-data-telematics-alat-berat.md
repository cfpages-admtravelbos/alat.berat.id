...
description: "Define data owner/controller roles, purpose, access, consent/notice where applicable, retention, sharing, export, deletion, alerts, incident response, and audit trail"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Tata Kelola Data Telematics: Akses, Retensi, Privasi, dan Audit”
- **Reader and situation:** Owner integrating OEM, rental, GPS, operator, and maintenance systems
- **Reader outcome:** Define data owner/controller roles, purpose, access, consent/notice where applicable, retention, sharing, export, deletion, alerts, incident response, and audit trail
- **Primary intent:** Establish accountable fleet-data governance
...
- **Scope boundary:** Excludes legal compliance advice and covert monitoring; ABR-10-06 owns sensor/data meaning and qualified privacy/security counsel owns legal interpretation
- **Final public route:** `/artikel/tata-kelola-data-telematics-alat-berat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Tata Kelola Data Telematics: Akses, Retensi, Privasi, dan Audit**.
...
- **Tie back to this article:** Keep the explanation specific to “Tata Kelola Data Telematics: Akses, Retensi, Privasi, dan Audit”.
