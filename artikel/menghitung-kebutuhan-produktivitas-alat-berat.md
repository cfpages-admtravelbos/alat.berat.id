...
description: "Show units, availability assumptions, cycle-time structure, losses, and sensitivity without promising output"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Menghitung Kebutuhan Produktivitas Alat Berat dari Target Pekerjaan”
- **Reader and situation:** Planner with quantities, duration, shifts, and preliminary cycle data
- **Reader outcome:** Show units, availability assumptions, cycle-time structure, losses, and sensitivity without promising output
- **Primary intent:** Convert work target into required production rate
...
- **Scope boundary:** Excludes model capacity and commercial fleet availability; ABR-02-05 owns fleet matching and ABR-13-06 owns total cost
- **Final public route:** `/artikel/menghitung-kebutuhan-produktivitas-alat-berat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Menghitung Kebutuhan Produktivitas Alat Berat dari Target Pekerjaan**.
...
- **Tie back to this article:** Keep the explanation specific to “Menghitung Kebutuhan Produktivitas Alat Berat dari Target Pekerjaan”.
