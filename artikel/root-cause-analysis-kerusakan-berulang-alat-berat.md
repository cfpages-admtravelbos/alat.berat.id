...
description: "Structure problem definition, chronology, physical evidence, maintenance/operation context, contamination, load, environment, failed controls, causal testing, action, and verification"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Root Cause Analysis Kerusakan Berulang Alat Berat”
- **Reader and situation:** Fleet team seeing repeated component, seal, overheating, or wear events
- **Reader outcome:** Structure problem definition, chronology, physical evidence, maintenance/operation context, contamination, load, environment, failed controls, causal testing, action, and verification
- **Primary intent:** Investigate recurring failures beyond replacing parts
...
- **Scope boundary:** Excludes blaming operators without evidence and invented causation; ABR-15-03 owns fluid trends and ABR-18-06 owns organizational learning
- **Final public route:** `/artikel/root-cause-analysis-kerusakan-berulang-alat-berat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Root Cause Analysis Kerusakan Berulang Alat Berat**.
...
- **Tie back to this article:** Keep the explanation specific to “Root Cause Analysis Kerusakan Berulang Alat Berat”.
