...
description: "Define event boundaries, scheduled time, availability, utilization, production, delay, idle, downtime codes, data completeness, segmentation, and safety guardrails"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “KPI Armada Alat Berat: Availability, Utilization, Productivity, dan Downtime”
- **Reader and situation:** Fleet manager building or auditing a dashboard
- **Reader outcome:** Define event boundaries, scheduled time, availability, utilization, production, delay, idle, downtime codes, data completeness, segmentation, and safety guardrails
- **Primary intent:** Define fleet metrics without hidden denominator changes
...
- **Scope boundary:** Excludes universal target values and operator league tables; ABR-17-02 owns fuel normalization and ABR-10-06 owns telematics data limits
- **Final public route:** `/artikel/kpi-armada-alat-berat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **KPI Armada Alat Berat: Availability, Utilization, Productivity, dan Downtime**.
...
- **Tie back to this article:** Keep the explanation specific to “KPI Armada Alat Berat: Availability, Utilization, Productivity, dan Downtime”.
