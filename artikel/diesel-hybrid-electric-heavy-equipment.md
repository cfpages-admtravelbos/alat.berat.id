---
article_id: ABR-17-03
title: "Diesel, Hybrid, dan Electric Heavy Equipment: Batas Perbandingan"
slug: "diesel-hybrid-electric-heavy-equipment"
description: "Compare duty, power/energy, charging/fueling, grid/site capacity, temperature, downtime, transport, maintenance, safety, local emissions, and lifecycle boundary"
status: outline
publication_date: "2026-06-17"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: ABR-17
primary_intent: "Compare powertrain pathways with system boundaries"
reader_community: "Berat.id"
reader_address: "Kawan Berat.id"
final_route: "/artikel/diesel-hybrid-electric-heavy-equipment.html"
...
# Diesel, Hybrid, dan Electric Heavy Equipment: Batas Perbandingan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Diesel, Hybrid, dan Electric Heavy Equipment: Batas Perbandingan”
- **Reader and situation:** Owner assessing electrification claims for a duty cycle
- **Reader outcome:** Compare duty, power/energy, charging/fueling, grid/site capacity, temperature, downtime, transport, maintenance, safety, local emissions, and lifecycle boundary
- **Primary intent:** Compare powertrain pathways with system boundaries
...
- **Scope boundary:** Excludes universal carbon claims, purchase recommendations, and current incentives; ABR-13-06 owns economics and verified project/OEM data owns performance
- **Final public route:** `/artikel/diesel-hybrid-electric-heavy-equipment.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Diesel, Hybrid, dan Electric Heavy Equipment: Batas Perbandingan**.
...
- `ABR-17-01` → `/artikel/pencegahan-tumpahan-fluida-alat-berat.html` — Pencegahan dan Respons Tumpahan BBM, Oli, dan Fluida Alat Berat
- `ABR-17-02` → `/artikel/mengukur-idle-fuel-dan-produktivitas-alat-berat.html` — Mengukur Idle, Fuel Burn, dan Produktivitas tanpa Menyesatkan
...
- **Tie back to this article:** Keep the explanation specific to “Diesel, Hybrid, dan Electric Heavy Equipment: Batas Perbandingan”.
