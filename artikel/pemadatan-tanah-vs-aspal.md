---
article_id: ABR-05-03
title: "Pemadatan Tanah vs Aspal: Variabel yang Tidak Boleh Disamakan"
slug: "pemadatan-tanah-vs-aspal"
description: "Explain material state, moisture/temperature, lift thickness, energy, pattern, density evidence, and failure symptoms"
status: outline
publication_date: "2025-09-03"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: ABR-05
primary_intent: "Distinguish soil and asphalt compaction control"
reader_community: "Berat.id"
reader_address: "Kawan Berat.id"
final_route: "/artikel/pemadatan-tanah-vs-aspal.html"
...
# Pemadatan Tanah vs Aspal: Variabel yang Tidak Boleh Disamakan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Pemadatan Tanah vs Aspal: Variabel yang Tidak Boleh Disamakan”
- **Reader and situation:** Supervisor moving between earthwork and paving
- **Reader outcome:** Explain material state, moisture/temperature, lift thickness, energy, pattern, density evidence, and failure symptoms
- **Primary intent:** Distinguish soil and asphalt compaction control
...
- **Scope boundary:** Excludes project acceptance values and laboratory interpretation beyond competence; ABR-05-04 owns rolling trials and project specifications own criteria
- **Final public route:** `/artikel/pemadatan-tanah-vs-aspal.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Pemadatan Tanah vs Aspal: Variabel yang Tidak Boleh Disamakan**.
...
- **Exact Markdown to insert:** `![Ilustrasi jasa aspal 3](/wp-content/uploads/2020/11/jasa-aspal-3.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `jasa aspal 3` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “Pemadatan Tanah vs Aspal: Variabel yang Tidak Boleh Disamakan”.
