---
article_id: ABR-16-06
title: "Repair, Component Rebuild, atau Replace: Kerangka Keputusan"
slug: "repair-rebuild-atau-replace-alat-berat"
description: "Compare defect scope, remaining structure, parts, capability, tolerance evidence, contamination, warranty, downtime, lifecycle cost, residual risk, and acceptance testing"
status: outline
publication_date: "2026-06-05"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: ABR-16
primary_intent: "Choose a component/equipment recovery strategy"
reader_community: "Berat.id"
reader_address: "Teman Berat.id"
final_route: "/artikel/repair-rebuild-atau-replace-alat-berat.html"
...
# Repair, Component Rebuild, atau Replace: Kerangka Keputusan

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Repair, Component Rebuild, atau Replace: Kerangka Keputusan”
- **Reader and situation:** Owner facing major failure or aging fleet
- **Reader outcome:** Compare defect scope, remaining structure, parts, capability, tolerance evidence, contamination, warranty, downtime, lifecycle cost, residual risk, and acceptance testing
- **Primary intent:** Choose a component/equipment recovery strategy
...
- **Scope boundary:** Excludes workshop endorsement, repair design, or promised life; `/layanan/component-rebuild` owns offers and ABR-13-06 owns TCO
- **Final public route:** `/artikel/repair-rebuild-atau-replace-alat-berat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Repair, Component Rebuild, atau Replace: Kerangka Keputusan**.
...
- **Exact Markdown to insert:** `![Ilustrasi Component Rebuild 2](/wp-content/uploads/2020/11/Component-Rebuild-2.jpg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Component Rebuild 2` as relevant content media; no pixels were inspected.
...
- **Tie back to this article:** Keep the explanation specific to “Repair, Component Rebuild, atau Replace: Kerangka Keputusan”.
