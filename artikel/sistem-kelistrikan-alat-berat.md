...
description: "Explain battery state, connections, ground, starter, alternator, voltage drop concept, fuses, relays, sensors, and safe measurement boundaries"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Sistem Kelistrikan Alat Berat: Battery, Starting, Charging, dan Ground”
- **Reader and situation:** Operator or technician triaging no-start or intermittent power symptoms
- **Reader outcome:** Explain battery state, connections, ground, starter, alternator, voltage drop concept, fuses, relays, sensors, and safe measurement boundaries
- **Primary intent:** Understand starting and charging evidence
...
- **Scope boundary:** Excludes jump-start or live testing without OEM controls; ABR-16-03 owns diagnostic workflow and qualified technicians own intrusive tests
- **Final public route:** `/artikel/sistem-kelistrikan-alat-berat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Sistem Kelistrikan Alat Berat: Battery, Starting, Charging, dan Ground**.
...
- **Tie back to this article:** Keep the explanation specific to “Sistem Kelistrikan Alat Berat: Battery, Starting, Charging, dan Ground”.
