---
article_id: ABR-03-06
title: "Mendiagnosis Bottleneck pada Siklus Gali–Muat–Angkut–Hampar"
slug: "bottleneck-siklus-gali-muat-angkut-hampar"
description: "Trace cycle segments, delays, payload variance, haul condition, dumping, spreading, and rework to the controlling constraint"
status: outline
publication_date: "2025-07-28"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: ABR-03
primary_intent: "Diagnose low earthmoving production"
reader_community: "Berat.id"
reader_address: "Kawan Berat.id"
final_route: "/artikel/bottleneck-siklus-gali-muat-angkut-hampar.html"
...
# Mendiagnosis Bottleneck pada Siklus Gali–Muat–Angkut–Hampar

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Mendiagnosis Bottleneck pada Siklus Gali–Muat–Angkut–Hampar”
- **Reader and situation:** Planner with queues, idle machines, or missed tonnage targets
- **Reader outcome:** Trace cycle segments, delays, payload variance, haul condition, dumping, spreading, and rework to the controlling constraint
- **Primary intent:** Diagnose low earthmoving production
...
- **Scope boundary:** Excludes mechanical diagnosis and commercial fleet changes; ABR-16-02 owns machine faults and ABR-02-05 owns fleet balancing
- **Final public route:** `/artikel/bottleneck-siklus-gali-muat-angkut-hampar.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Mendiagnosis Bottleneck pada Siklus Gali–Muat–Angkut–Hampar**.
...
- `/jasa/gali/saluran` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa/gali/basement` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa/gali/` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa/gali/saluran/` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/jasa/gali/basement/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “Mendiagnosis Bottleneck pada Siklus Gali–Muat–Angkut–Hampar”.
