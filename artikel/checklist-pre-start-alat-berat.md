---
article_id: ABR-15-01
title: "Checklist Pre-Start Alat Berat Berlapis: Operator, Supervisor, dan Maintenance"
slug: "checklist-pre-start-alat-berat"
description: "Separate operator walkaround/function cues, supervisor environment/authorization checks, and maintenance escalation with defect severity and stop-work paths"
status: outline
publication_date: "2026-04-22"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: ABR-15
primary_intent: "Build a layered pre-start inspection"
reader_community: "Berat.id"
reader_address: "Sobat Berat.id"
final_route: "/artikel/checklist-pre-start-alat-berat.html"
...
# Checklist Pre-Start Alat Berat Berlapis: Operator, Supervisor, dan Maintenance

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Checklist Pre-Start Alat Berat Berlapis: Operator, Supervisor, dan Maintenance”
- **Reader and situation:** Fleet team replacing a generic tick-box form
- **Reader outcome:** Separate operator walkaround/function cues, supervisor environment/authorization checks, and maintenance escalation with defect severity and stop-work paths
- **Primary intent:** Build a layered pre-start inspection
...
- **Scope boundary:** Excludes model-specific limits and permission to operate with defects; OEM manual owns exact checks and ABR-16-04 owns critical-defect triage
- **Final public route:** `/artikel/checklist-pre-start-alat-berat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Checklist Pre-Start Alat Berat Berlapis: Operator, Supervisor, dan Maintenance**.
...
- **Tie back to this article:** Keep the explanation specific to “Checklist Pre-Start Alat Berat Berlapis: Operator, Supervisor, dan Maintenance”.
