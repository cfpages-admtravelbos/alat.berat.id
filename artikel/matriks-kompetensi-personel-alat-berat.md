---
article_id: ABR-18-01
title: "Matriks Kompetensi Operator, Spotter, Supervisor, dan Mekanik"
slug: "matriks-kompetensi-personel-alat-berat"
description: "Map task, machine/configuration, hazard, knowledge, practical demonstration, authorization, supervision, refresher, change trigger, and record evidence by role"
status: outline
publication_date: "2026-07-05"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: ABR-18
primary_intent: "Define role-specific competence evidence"
reader_community: "Berat.id"
reader_address: "Sobat Berat.id"
final_route: "/artikel/matriks-kompetensi-personel-alat-berat.html"
...
# Matriks Kompetensi Operator, Spotter, Supervisor, dan Mekanik

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Matriks Kompetensi Operator, Spotter, Supervisor, dan Mekanik”
- **Reader and situation:** Organization assigning people to equipment work
- **Reader outcome:** Map task, machine/configuration, hazard, knowledge, practical demonstration, authorization, supervision, refresher, change trigger, and record evidence by role
- **Primary intent:** Define role-specific competence evidence
...
- **Scope boundary:** Excludes issuing certification or declaring a person competent from attendance; ABR-11-01 owns job controls and authorized assessors/employers own decisions
- **Final public route:** `/artikel/matriks-kompetensi-personel-alat-berat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Matriks Kompetensi Operator, Spotter, Supervisor, dan Mekanik**.
...
- `ABR-18-02` → `/artikel/shift-handover-alat-berat.html` — Shift Handover Alat Berat: Kondisi, Defek, Pekerjaan, dan Perubahan Risiko
...
- **Tie back to this article:** Keep the explanation specific to “Matriks Kompetensi Operator, Spotter, Supervisor, dan Mekanik”.
